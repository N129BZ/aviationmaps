## This electron application displays FAA charts, OpenStreetMaps, animated weather, and much more, using electron, node, and express with the OpenLayers map API.        
